...
> 面向 Clash Verge Rev、Clash Meta 和 Clash 系客户端的免费节点文章入口。
...
请打开上面的博客文章，在正文“免费订阅地址”区域获取当天可用入口。Clash 配置和代理组说明放在站内文章里统一更新，仓库只做导航。
...
本站每日北京时间 00:00 自动处理免费节点用户：重置流量、刷新订阅 Token、写入服务端动态数据，并同步 GitHub 分享仓库。Clash 用户建议先看当天文章，再按导入教程刷新配置。 仓库里的 `sub/latest.txt` 只保存当天文章链接，不保存真实订阅地址。
